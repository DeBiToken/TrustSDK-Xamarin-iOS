...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrustSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS_NAMED("TrustSDK")
@interface TrustSDK : NSObject
- (nonnull instancetype)initWithCallbackScheme:(NSString * _Nonnull)callbackScheme OBJC_DESIGNATED_INITIALIZER;
/// Handles an open URL callback
///
/// returns:
/// <code>true</code> is the URL was handled; <code>false</code> otherwise.
- (BOOL)handleCallbackWithUrl:(NSURL * _Nonnull)url SWIFT_WARN_UNUSED_RESULT;
